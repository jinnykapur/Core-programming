...
Hint => 
Armstrong Number is a number whose Sum of cubes of each digit results in 
...
Again in while loop find the quotient of the number using the division operation number/10 
