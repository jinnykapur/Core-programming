...
public class disConInput{
	public static void main(String args[]){
		Scanner sc=new Scanner(System.in);
		
		double km=sc.nextDouble();
		double dmile=km*1.6;
		System.out.println("The total miles is "+dmile+" mile for the given "+km+" km.");
		//Output: The total miles is 19.200000000000003 mile for the given 12.0 km.
